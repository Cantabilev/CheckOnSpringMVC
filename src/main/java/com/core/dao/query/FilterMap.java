...
import com.core.dao.query.support.FilterParam;
...
public class FilterMap extends LinkedHashMap<FilterParam,Object> {
     ...
     * @param value
     */
    public void ge(String column,Long value){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_GREATER_EQUAL);
        this.put(param,value);
    }
     ...
     * @param value
     */
    public void le(String column,Long value){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_LESS_EQUAL);
        this.put(param,value);
    }
     ...
     * @param values
     */
    public void inString(String column,List<String> values){
     ...
     * @param values
     */
    public void inString(String column,String[] values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_IN);
        this.put(param,values);
    }
     ...
     * @param values
     */
    public void in(String column,List<Long> values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_IN);
        this.put(param,values);
    }
     ...
     * @param values
     */
    public void inInteger(String column,List<Integer> values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_IN);
        this.put(param,values);
    }
     ...
     * @param values
     */
    public void inInteger(String column,Integer[] values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_IN);
        this.put(param,values);
    }
     ...
     * @param values
     */
    public void notIn(String column,List<Long> values){
     ...
     * @param values
     */
    public void notInString(String column,List<Long> values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_NOT_IN);
        this.put(param,values);
    }
     ...
     * @param values
     */
    public void notInInteger(String column,List<Integer> values){
        FilterParam param = new FilterParam(DynamicQuery.LOGIC_AND,column,DynamicQuery.OPERATOR_NOT_IN);
        this.put(param,values);
    }
