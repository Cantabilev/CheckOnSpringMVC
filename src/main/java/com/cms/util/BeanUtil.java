...
public class BeanUtil extends BeanUtils {
    ...
    /**
     * 通过getter方法比较两个对象的属性， 返回有变化的属性名列表
     * <see> 如果 target.propertyName == null 则不返回
     * <see> 如果 source.propertyName == null && target.propertyName != null  则返回 [propertyName]
     * <see> 如果  !source.propertyName.equals(target.propertyName) 则返回[propertyName]
     * @param source
     * @param target
     * @return
     * @author zhaofei
    ...
    private static void copyPermitedProperties(Object source, Object target, Class<?> editable, String... permitProperties)
